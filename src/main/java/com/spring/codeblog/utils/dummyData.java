...
@Component
 class DummyData {
    ...
    //@PostConstruct    Sem ele não é possivel setar novos dados no banco
    public void savePosts(){

        List<Post> postList = new ArrayList<>();
        Post post1 = new Post();
        post1.setAutor("Elon Musk");
        post1.setData(LocalDate.now());
        post1.setTitulo("Starlink");
        ...
        Post post2 = new Post();
        post2.setAutor("Jeff B.");
        post2.setData(LocalDate.now());
        post2.setTitulo("Rocket ship");
